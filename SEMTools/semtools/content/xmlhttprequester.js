function adhighlighter_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
adhighlighter_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				adhighlighter_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
adhighlighter_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
adhighlighter_xmlhttpRequester.prototype.setupRequestEvent =
